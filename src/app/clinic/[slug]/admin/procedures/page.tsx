...
export default async function ProceduresPage({ params, searchParams }: Props) {
  ...
  const [procedures, total, consentTemplates] = await Promise.all([
    ...
    prisma.procedure.count({ where: { clinicId: user.clinicId } }),
